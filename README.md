...
- командой <b><число координаты по оси X> <число координаты по оси Y> mine</b> пометить поле миной/снять метку мины с поля<br>
...
- командой <b><число координаты по оси X> <число координаты по оси Y> free</b> открыть клетку<br>
